...
def send_text(message):
	...
	if "/url" in message.text:
		...
		bot.send_message(message.chat.id, "Введите коректную команду - скриншот или /url ")

	# else:
	# 	msg = message.chat.first_name + " спизданул следующее: " + message.text
	# 	for i in users:
	# 		if i.id != message.chat.id:
	# 			bot.send_message(i.id, msg)
